...
function link1() {
  window.open('https://weathervictoria.github.io/WeatherVictoria/Victoria_purple_/');
}
...
function draw() {
  ...
  text('And the movements of Victoria the plant', 50, 220);
  text('which, lazily, follow the rules set daily', 50, 240);
  text('by the sun, clouds, rain and stars.', 50, 260);
  
  
  text('Victoria opens and closes', 50, 380);
  text('Victoria closes and opens', 50, 400);
  text('plants seem still', 50, 420);
  text('when they just move', 50, 440);
  text('really slowly', 50, 460);
  text('nature dances', 50, 480);
  text('at the kindest pace.', 50, 500);
  pop();
